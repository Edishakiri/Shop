...
// Przedmioty w koszyku (cart items)
let cart = [];
// buttons 
...
class UI {
            ...
            <article class="product">
                <div class="img-container">
                    ...
                    <button class="bag-btn" data-id=${product.id}>
                        <i class="fas fa-shopping-cart">Dodaj do koszyka</i>
                    </button>
                </div>
                <h3>${product.title}</h3>
                <h4>${product.price}zł / 10 dag</h4>
            </article>
            <!-- Koniec pierwsszy produkt -->
            `
        })
    ...
    addCartItem(item){
        ...
        <img src=${item.image} alt="product">
                    <div>
                        <h4>${item.title}</h4>
                        <h5>${item.price}zł / 10 dag</h5>
                        <span class="remove-item" data-id=${item.id}>Usuń kawe</span>
                    </div>
                    <div>
